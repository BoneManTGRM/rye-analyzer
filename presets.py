...
PRESETS: Dict[str, Preset] = {
    ...
    # Marine specific biology presets (merged v1 + v2 into one)
    "Marine Biology": Preset(
        ...
        tooltips={
            ...
            "Energy": "Use effort, tows, transects, respiration, PAR, or nutrients as sampling or stress cost.",
            "Time": "Date, season, or sample_time, often binned to daily, weekly, or seasonal steps.",
