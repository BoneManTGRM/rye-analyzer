...
PRESETS: Dict[str, Preset] = {
    ...
    "AI": Preset(
        ...
        default_rolling=50,
        tooltips={
            "Performance": "Use accuracy, F1, reward, or loss_inv to track model quality.",
            "Energy": "Use tokens, gpu_hours, flops, or cost as the effort axis.",
    ...
    "Robotics": Preset(
        name="Robotics",
        time=_kw("t", "time", "cycle", "episode", "trial", "step"),
        performance=_kw(
            "task_success",
            "success_rate",
            "score",
        ...
        default_rolling=20,
        tooltips={
            "Performance": "Use success_rate, tracking_inv, or mean_reward for control quality.",
            "Energy": "Use battery_used, power, or motor_current as task cost.",
    ...
    "DevOps/SRE": Preset(
        ...
        tooltips={
            ...
            "Domain": "Group by service, cluster, region, or deployment ring.",
        },
    ),
    "Networking": Preset(
        name="Networking",
    ...
    "Chemistry": Preset(
        ...
        default_rolling=10,
        tooltips={
            "Performance": "Use yield, purity, or conversion as reaction output.",
            "Energy": "Use temp, reagent amount, or pressure as energy input.",
            "Domain": "Group by reaction_id, catalyst, or solvent.",
        },
    ),
    "Physics Lab": Preset(
        name="Physics Lab",
