...
PRESETS: Dict[str, Preset] = {
    ...
    "Marine Biology": Preset(
        ...
        tooltips={
            ...
            "Energy": "Use effort, tows, transects, volume_filtered, respiration, PAR, nutrients, or depth (depth, minimumdepth, minimumdepthinmeters, maximumdepth, maximumdepthinmeters) as sampling or stress cost.",
